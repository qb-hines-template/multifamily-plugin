...
export interface PluginEntratafeedFloorPlanConfiguration
  ...
  info: {
    displayName: 'Floor Plan Configuration';
    pluralName: 'floor-plan-configurations';
    singularName: 'floor-plan-configuration';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    enableEngrainPricing: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    engrainPrice: Schema.Attribute.String;
    engrainPriceLabel: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Call for Pricing'>;
    floorplanCard: Schema.Attribute.Component<
      'plugin::entratafeed.floorplan-card',
      false
    >;
    floorplanFilters: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::entratafeed.floorplan-filter'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface PluginEntratafeedFloorplanFilter
  extends Struct.CollectionTypeSchema {
  collectionName: 'floorplan-filters';
  info: {
    description: '';
    displayName: 'Floorplan Filter';
    pluralName: 'floorplan-filters';
    singularName: 'floorplan-filter';
  };
  options: {
    draftAndPublish: true;
  };
